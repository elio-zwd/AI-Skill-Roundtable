...
UI_MAPPING = {
    "elon-musk-skill-main": {
        "id": "elon_musk",
        "name": "埃隆·马斯克",
        "avatar": "avatars/portraits/elon_musk.jpg",
    ...
    "feynman-skill-main": {
        "id": "richard_feynman",
        "name": "理查德·费曼",
        "avatar": "avatars/portraits/richard_feynman.jpg",
    ...
    "munger-skill-main": {
        "id": "charlie_munger",
        "name": "查理·芒格",
        "avatar": "avatars/portraits/charlie_munger.jpg",
    ...
    "naval-skill-main": {
        "id": "naval_ravikant",
        "name": "纳瓦尔",
        "avatar": "avatars/portraits/naval_ravikant.jpg",
    ...
    "steve-jobs-skill-main": {
        "id": "steve_jobs",
        "name": "史蒂夫·乔布斯",
        "avatar": "avatars/portraits/steve_jobs.jpg",
    ...
    "taleb-skill-main": {
        "id": "nassim_taleb",
        "name": "纳西姆·塔勒布",
        "avatar": "avatars/portraits/nassim_taleb.jpg",
    ...
    "karpathy-skill": {
        "id": "andrej_karpathy",
        "name": "安德烈·卡帕斯",
        "avatar": "avatars/portraits/andrej_karpathy.jpg",
    ...
    "zhang-yiming-skill": {
        "id": "zhang_yiming",
        "name": "张一鸣",
        "avatar": "avatars/portraits/zhang_yiming.jpg",
    ...
    "paul-graham-skill": {
        "id": "paul_graham",
        "name": "保罗·格雷厄姆",
        "avatar": "avatars/portraits/paul_graham.jpg",
    ...
    "ilya-sutskever-skill": {
        "id": "ilya_sutskever",
        "name": "伊利亚·苏茨克维尔",
        "avatar": "avatars/portraits/ilya_sutskever.jpg",
    ...
    "trump-skill": {
        "id": "donald_trump",
        "name": "唐纳德·特朗普",
        "avatar": "avatars/portraits/donald_trump.jpg",
    ...
    "mrbeast-skill": {
        "id": "mr_beast",
        "name": "吉米·唐纳森 (MrBeast)",
        "avatar": "avatars/portraits/mr_beast.jpg",
    ...
    "sun-yuchen-perspective": {
        "id": "justin_sun",
        "name": "孙宇晨",
        "avatar": "avatars/portraits/justin_sun.jpg",
    ...
    "freud-skill": {
        "id": "sigmund_freud",
        "name": "西格蒙德·弗洛伊德",
        "avatar": "avatars/portraits/sigmund_freud.jpg",
    ...
    "x-mentor-skill": {
        "id": "x_mentor",
        "name": "X 增长导师",
        "avatar": "avatars/portraits/x_mentor.jpg",
    ...
    "fengge-skill": {
        "id": "feng_ge",
        "name": "峰哥亡命天涯",
        "avatar": "avatars/portraits/feng_ge.jpg",
    ...
    "cz-skill": {
        "id": "changpeng_zhao",
        "name": "赵长鹏 (CZ)",
        "avatar": "avatars/portraits/changpeng_zhao.jpg",
    ...
    "duan-yongping-skill": {
        "id": "duan_yongping",
        "name": "段永平",
        "avatar": "avatars/portraits/duan_yongping.jpg",
    ...
    "tim-cook-skill": {
        "id": "tim_cook",
        "name": "蒂姆·库克",
        "avatar": "avatars/portraits/tim_cook.jpg",
