...
[Interactions API](https://ai.google.dev/gemini-api/docs/interactions-overview). The Interactions API is our simplest and best way to build with Gemini models and agents. This skill covers:
