> [!NOTE]
> **Note:** This version of the page covers the **Interactions API** . You can use the toggle on this page to switch to the [generateContent API version of this page](https://ai.google.dev/gemini-api/docs/generate-content/whats-new-gemini-3.5).
...
including [Computer Use (Preview)](https://ai.google.dev/gemini-api/docs/computer-use).
...
- [Computer Use](https://ai.google.dev/gemini-api/docs/computer-use) is supported.
...
- [**Thought signatures**](https://ai.google.dev/gemini-api/docs/thought-signatures)**:** Encrypted representations of the model's internal reasoning. Required for multi-turn function calling in stateless mode; managed automatically by the Interactions API and the official SDKs.
