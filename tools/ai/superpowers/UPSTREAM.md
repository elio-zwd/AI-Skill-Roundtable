...
- 名称：Superpowers
- 本地版本：6.2.0
- 本地来源目录：`C:\Users\70455\.codex\plugins\cache\openai-curated-remote\superpowers\6.2.0`（仅记录本次导入来源；其他机器路径可能不同）
...
- 敏感信息审计：未发现真实 Token、API Key、Cookie、密码、本机用户路径、私有服务地址或私有对话记录；视觉伴侣会话脚本未引入
